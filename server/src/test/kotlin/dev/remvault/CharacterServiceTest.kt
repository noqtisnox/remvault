...
class CharacterServiceTest {
    ...
    fun `createCharacter returns a sheet`() {
        val sheet = CharacterService.createCharacter(userId, "Gandalf", "Human", "wizard", "Sage")
    ...
    fun `createCharacter computes correct HP for wizard`() {
        // wizard hitDie=6, HP depends on CON modifier — just check it's positive
        val sheet = CharacterService.createCharacter(userId, "Gandalf", "Human", "wizard", "Sage")
    ...
    fun `getCharacter returns sheet for valid id`() {
        val created = CharacterService.createCharacter(userId, "Gandalf", "Human", "wizard", "Sage")
    ...
    fun `getCharactersByUser returns only own characters`() {
        CharacterService.createCharacter(userId, "Gandalf", "Human", "wizard", "Sage")
        CharacterService.createCharacter(userId, "Aragorn", "Human", "fighter", "Soldier")
        CharacterService.createCharacter(otherUserId, "Legolas", "Elf", "ranger", "Outlander")
